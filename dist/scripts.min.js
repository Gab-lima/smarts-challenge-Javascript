...
$("#menu-toggle").click(function(){$(this).toggleClass("active"),$("aside").toggleClass("active")});
function handleAccordion(n){$(n).parent().parent().toggleClass("active")}
function getData(){$.ajax({dataType:"json",url:"http://localhost:5000/api/v1/customer",data:{}}).done(function(a){console.log(a),insertItens(a)})}function insertItens(a){$("#content").empty(),a.forEach(function(a){$("#content").append('<div class="accordion-item"><div class="accordion-header"><button class="toggle-accordion" onclick="handleAccordion(this);"> + </button><img src="https://picsum.photos/200/300" alt=""><div class="accor-about"><p><b>Name:</b><span>'+a.name.first+" "+a.name.last+"</span> </p><p><b>Age:</b><span>"+a.age+"</span> </p><p><b>E-mail:</b><span>"+a.email+"</span></p><p><b>Company:</b><span>"+a.company+"a</span> </p><p><b>Budget:</b><span>"+a.budget+' </span> </p></div></div><div class="accordion-body"><div class="accor-about"><p><b>phone:</b><span>'+a.phone+"</span> </p><p><b>address:</b><span>"+a.address+"</span> </p><p><b>about:</b><span>"+a.about+"</span></p><p><b>latitude:</b><span>"+a.latitude+"</span> </p><p><b>longitude:</b><span>"+a.longitude+"</span> </p><p><b>channel:</b><span>"+a.channel+"</span> </p><p><b>registered:</b><span>"+a.registered+"</span> </p></div></div></div>")})}$("#filter").on("change",function(){var a="";switch($(this).val()){case"menor-budget":a="http://localhost:5000/api/v1/customer/search/budget/asc";break;case"maior-budget":a="http://localhost:5000/api/v1/customer/search/budget/desc";break;case"asc":a="http://localhost:5000/api/v1/customer/search/az";break;case"desc":a="http://localhost:5000/api/v1/customer/search/za"}""!=a&&$.ajax({dataType:"json",url:a,data:{}}).done(function(a){console.log(a),insertItens(a)})}),$("#search-date").on("click",function(){var a=$("#date-start").val(),t=$("#date-end").val();return""==a||""==t?(alert("Por favor digite as duas datas!"),!1):(console.log("teste"),$.ajax({dataType:"json",url:"http://localhost:5000/api/v1/customer/search/registered",data:{start_date:a,end_date:t}}).done(function(a){console.log(a),insertItens(a)}),!0)});